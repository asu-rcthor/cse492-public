...
**Because this is a console application, you will not be able to click on your file explorer directly. You will need to launch this via a terminal (such as Powershell on Windows, Zsh on Mac, or bash on Linux).**
